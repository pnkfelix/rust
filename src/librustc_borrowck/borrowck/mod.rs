...
impl<'a, 'tcx, 'v> Visitor<'v> for BorrowckCtxt<'a, 'tcx> {
    fn visit_fn(&mut self, fk: FnKind<'v>, fd: &'v FnDecl,
        ...
        match fk {
            FnKind::ItemFn(..) |
            FnKind::Method(..) => {
                self.with_temp_region_map(id, |this| borrowck_fn(this, fk, fd, b, s, id, fk.attrs()));
            }
...
pub fn check_crate<'tcx>(tcx: &ty::ctxt<'tcx>, mir_map: Option<&MirMap<'tcx>>) {
...
fn borrowck_fn(this: &mut BorrowckCtxt,
    ...
    if attributes.iter().any(|item| item.check_name("rustc_mir")) {
        ...
        this.with_temp_region_map(id, |this| mir::borrowck_mir(this, fk, decl, mir, body, sp, id, attributes));
    }
