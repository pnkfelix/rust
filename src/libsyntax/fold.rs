    ...
    fn fold_view_path(&mut self, view_path: Gc<ViewPath>) -> Gc<ViewPath> {
        let inner_view_path = match view_path.node {
            ViewPathSimple(ref ident, ref path, node_id) => {
                ...
                debug!("fold_view_path, id: {}, ViewPathSimple", id);
