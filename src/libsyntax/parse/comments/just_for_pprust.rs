...
use parse::lexer::is_block_non_doc_comment;
use parse::lexer;
use parse::token;
use parse::token::{get_ident_interner};
use parse::comments::{is_doc_comment};

use std::io;
use std::str;

// these functions are to support gather_comments_and_literals,
// which is called only from pprust.  If/when pprust is factored
// out of libsyntax (Issue #3195), this module should go away.
