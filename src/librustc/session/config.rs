...
options! {DebuggingOptions, DebuggingSetter, basic_debugging_options,
    ...
    incremental_dont_internalize_symbols: bool = (false, parse_bool, [TRACKED],
        "do not run internalize_symbols optimization when incremental compilation is turned on."),
