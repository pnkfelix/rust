...
pub enum LoanPath {
    ...
    LpCopiedUpvar(ty::UpvarId),       // `x` captured by-value into closure
...
pub fn opt_loan_path(cmt: &mc::cmt) -> Option<Rc<LoanPath>> {
    ...
    match cmt.cat {
        ...
        mc::cat_copied_upvar(mc::CopiedUpvar { upvar_id: id,
            ...
            Some(Rc::new(LpCopiedUpvar(upvar_id)))
        }
...
impl<'a> BorrowckCtxt<'a> {
    ...
    pub fn append_loan_path_to_str(&self,
                                   ...
                                   out: &mut String) {
        match *loan_path {
            LpCopiedUpvar(ty::UpvarId{ var_id: id, closure_expr_id: _ }) |
            LpVar(id) => {
    ...
    pub fn append_autoderefd_loan_path_to_str(&self,
        ...
        match *loan_path {
            ...
            LpVar(..) | LpCopiedUpvar(..) | LpExtend(_, _, LpInterior(..)) => {
...
impl Repr for LoanPath {
    fn repr(&self, tcx: &ty::ctxt) -> String {
        match self {
            ...
            &LpCopiedUpvar(ty::UpvarId{ var_id, closure_expr_id }) => {
