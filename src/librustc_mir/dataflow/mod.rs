...
impl<O: BitDenotation> DataflowState<O> {
    pub fn operator(&self) -> &O { &self.operator }
...
impl<'a, 'tcx: 'a, BD: BitDenotation> DataflowAnalysis<'a, 'tcx, BD>
{
...
impl<'b, 'a: 'b, 'tcx: 'a, BD: BitDenotation> PropagationContext<'b, 'a, 'tcx, BD>
{
