...
$$(HLIB$(2)_H_$(4))/$(CFG_LIBRUSTC_$(4)): \
	...
	@$$(call E, cp: $$@)
	$$(Q)$(C) cp $$< $$@
	$$(Q)$(C) cp -R $$(TLIB$(1)_T_$(4)_H_$(3))/$(LIBRUSTC_GLOB_$(4)) \
...
$$(HLIB$(2)_H_$(4))/$(CFG_LIBSYNTAX_$(4)): \
	...
	@$$(call E, cp: $$@)
	$$(Q)$(C) cp $$< $$@
	$$(Q)$(C) cp -R $$(TLIB$(1)_T_$(4)_H_$(3))/$(LIBSYNTAX_GLOB_$(4)) \
...
# (Copy .dsym file if it exists, but do nothing otherwise)
	$$(Q)$(C) cp -R $$(TLIB$(1)_T_$(4)_H_$(3))/$(STDLIB_GLOB_$(4)) \
...
$$(HLIB$(2)_H_$(4))/$(CFG_EXTRALIB_$(4)): \
	...
	@$$(call E, cp: $$@)
	$$(Q)$(C) cp $$< $$@
	$$(Q)$(C) cp -R $$(TLIB$(1)_T_$(4)_H_$(3))/$(EXTRALIB_GLOB_$(4)) \
